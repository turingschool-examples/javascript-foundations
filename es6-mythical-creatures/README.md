...
Notice, some of the syntax with the tests and files are using es6 syntax like arrow functions, block-scoped variables, and classes.  See if you can start flexing your es6 muscles and write your solutions and tests using the new syntax!  
