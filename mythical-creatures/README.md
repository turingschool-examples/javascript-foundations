...
In your terminal, change into the `mythical-creatures` directory, and run the command `npm test test/unicorn-test.js`. To run other tests, just replace the creature name.
