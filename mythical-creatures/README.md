...
In your terminal, change into the `javavascript-foundations` directory(one directory up), and run the command `npm test mythical-creatures/test/unicorn-test.js`. To run other tests, just replace the creature name.
