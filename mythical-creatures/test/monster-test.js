...
describe('Monster', function(){
  ...
  it.skip('should default to a scariness of 0', function() {
    var monster = new Monster("Mike");
    assert.equal(monster.scariness, 0)
  })

  it.skip('should be able to have a higher scariness', function() {
    var monster = new Monster("George", 2);
    assert.equal(monster.scariness, 2)
  })

  it.skip('should default to not being contaminated', function() {
    var monster = new Monster("Sully");
  ...
  it.skip('Monsters should be able to scare children', function(){
    var monster = new Monster("Randall", 2);
    var child = new Child("Thomas");
    assert.equal(monster.scare(child), "RAWR");
  })

  it.skip('Children should scream when scared', function() {
    var monster = new Monster("Randall", 2);
    var child = new Child("Thomas");
    monster.scare(child);
  ...
  it.skip('Only monsters with a scariness 2 or greater should be able to scare chilren', function(){
  ...
  it.skip('Monsters with a scariness less than 2 should get contaminated if they try to scare a child', function(){
  ...
  it.skip('When children scream, they should produce scream-energy equal to the scariness of the monster minus the number of times they have screamed', function(){
  ...
  it.skip('Monsters should collect the scream-energy in a container', function(){
  ...
  it.skip('If returned scream-energy is zero, child is not scared and monster is contaminated', function(){
    var monster = new Monster("George", 2);
    var child = new Child("Timmy")
    monster.scare(child);
  ...
  it.skip('Monsters should be able to turn-in total scream-energy at the end of the day', function(){
...
describe('Child', function(){
  ...
  it.skip('should not be scared by default', function() {
    var child = new Child("George");
    assert.equal(child.scared, false);
  });

  it.skip("should be scared after screaming", function() {
  ...
  it.skip("should keep track of how many times it has screamed", function(){
    var monster = new Monster ("Fred", 4)
    var child = new Child("David");
    child.scream(monster);
    child.scream(monster);
