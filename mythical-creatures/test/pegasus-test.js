...
describe('Pegasus', function() {
  ...
  it.skip('should be able to have a different color and pattern', function() {
  ...
  it.skip('should know how to fly by default', function() {
  ...
  it.skip('should be able to make an entrance', function() {
